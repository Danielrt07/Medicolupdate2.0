...
export const metadata = {
  title: "Liposuction in Medellín | MediCol",
  description: "Advanced liposuction surgery in Medellín. Achieve your ideal body contours with our expert surgeons at significant cost savings."
}
...
export default function LiposuctionPage() {
  const benefits = [
    {
      ...
      description: "Advanced techniques for targeted fat removal and body sculpting"
    },
    {
      title: "Multiple Areas",
      description: "Can treat several body areas in a single session"
    },
    {
      title: "Long-lasting Results",
      description: "Permanent fat cell removal with proper lifestyle maintenance"
    },
    {
      title: "Minimal Scarring",
      description: "Tiny incisions that heal to be virtually invisible"
    }
  ]
  ...
  const recoverySteps = [
    {
      title: "Week 1",
      description: "Initial recovery with compression garments, moderate swelling"
    },
    {
      title: "Weeks 2-3",
      description: "Return to work, continue wearing compression garments"
    },
    {
      title: "Weeks 4-6",
      description: "Resume light exercise, swelling continues to decrease"
    },
    {
      title: "3-6 Months",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl text-white">
            ...
            <p className="text-xl md:text-2xl text-gray-200 mb-8">
              Achieve your ideal body contours with advanced liposuction techniques 
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our liposuction procedures use advanced techniques to precisely remove 
              stubborn fat deposits and sculpt your ideal body contours. We can treat 
              multiple areas in a single session, including abdomen, flanks, thighs, 
              arms, and chin, for comprehensive body contouring results.
            </p>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <p className="text-gray-600 mb-8">
                Price varies by treatment areas. Includes all medical fees, luxury 
