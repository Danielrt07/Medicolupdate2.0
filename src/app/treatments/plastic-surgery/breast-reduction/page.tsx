...
export const metadata = {
  title: "Breast Reduction in Medellín | MediCol",
  description: "Expert breast reduction surgery in Medellín. Find relief and achieve balanced proportions with our skilled surgeons at significant cost savings."
}

export default function BreastReductionPage() {
  const benefits = [
    {
      title: "Physical Relief",
      description: "Reduce back, neck, and shoulder pain from oversized breasts"
    },
    {
      title: "Better Proportions",
      description: "Achieve balanced, natural-looking breast size for your frame"
    },
    {
      title: "Improved Comfort",
      description: "Enjoy easier physical activity and better fitting clothes"
    },
    {
      title: "Enhanced Confidence",
      description: "Feel more comfortable and confident in your appearance"
    }
  ]
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-3xl text-white">
            <h1 className="font-playfair text-4xl md:text-6xl mb-6">
              Breast Reduction in Medellín
            </h1>
            <p className="text-xl md:text-2xl text-gray-200 mb-8">
              Find relief from physical discomfort and achieve balanced proportions 
              with our expert surgeons at a fraction of US costs.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg text-gray-600 mb-8">
              Our breast reduction procedures combine advanced surgical techniques 
              to remove excess breast tissue and reshape your breasts to a more 
              comfortable size. We focus on creating natural-looking results while 
